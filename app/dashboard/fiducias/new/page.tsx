...
export const metadata: Metadata = { title: "Nueva fiducia" };

export default function NewFiduciaPage() {
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">Nueva fiducia</h1>
        <p className="mt-1 text-sm text-muted">Crea una nueva fiducia en el sistema</p>
      </div>
