...
export const metadata: Metadata = { title: "Nuevo banco" };

export default function NewBancoPage() {
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">Nuevo banco</h1>
        <p className="mt-1 text-sm text-muted">Crea un nuevo banco en el sistema</p>
      </div>
      ...
      <EntityForm
        ...
        fields={[
          ...
          { name: "nit", label: "Código DANE", required: false },
